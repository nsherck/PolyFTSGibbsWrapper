...
if jobtype == "MF":
	...
	GM.VolFracBounds = [0.0001,0.9999]
	MW_List = [10]#[10,20]
	Xfrac_List = [0.02,0.06,0.08,0.10,0.12,0.20]#,0.20]#[0.02,0.04,0.06,0.08,0.10,0.15,0.20,0.25,0.30,0.40,0.50,0.60]
	...
	for i,N in enumerate(MW_List): # Loop over molecular weight
		...
		for j,_xfrac in enumerate(Xfrac_List): # loop over c_total
			...
			''' Set total species number and total volume. '''
			CTot = 0.068911851#CalcC(_xfrac) # number concentration
			...
			GM.SetDt([0.01*10/N,0.01*10/N,0.01*10/N])
